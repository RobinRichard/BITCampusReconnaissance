                            ...
                            answerstate.filter(data => data.question == item.id && data.answer_status == 3).length == 1 ?
                                ...
                                <View style={{ width: '100%', paddingLeft: 20, paddingRight: 20, marginTop: 10 }}>
                                    <KeyboardAvoidingView>
                                        <Textarea onChangeText={(text) => handleChange(text, item.id)} value={answertemp[item.id]} style={{ width: '85%', alignSelf: "center" }} rowSpan={4} bordered placeholder="Enter your answer here" />
                                        <TouchableOpacity>
